                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Liste des endroit et de leurs photo</h6>
                        </div>
                    </div>
                                    ...
                                    @foreach ($results as $result)
                                        <tr>
                                            <td>
                                                ...
                                                <p class="text-sm font-weight-bold mb-0"> {{ str_replace('http://www.semanticweb.org/mega-pc/ontologies/2023/9/untitled-ontology-6#', '', $result->photo) }}/p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->titre }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->auteur }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->imagePath }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->type }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->endroit }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->NomEndroit }}</p>
                                            </td>
                                    @endforeach
                                </tbody>
                            </table>
