                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Style Artistique</h6>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($results as $result)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->styleArtistique }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->principauxArtistes }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->periode }}</p>
                                            </td>
