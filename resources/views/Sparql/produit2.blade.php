            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <a href="{{ url('/nbProduitCat') }}" class="btn btn-dark" title="Ajouter une catégorie">
                            <span class="text-white text-capitalize ps-3">Nb Produit Par Catégories</span>
                        </a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle text-center font-weight-bolder opacity-7">Nombre de Produits</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <p class="text-secondary text-xs font-weight-bold">{{ $result->nombreProduits }}</p>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
