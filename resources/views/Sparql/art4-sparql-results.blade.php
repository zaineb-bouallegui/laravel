                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Affectation</h6>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($results as $result)
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->description }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->image }}</p>
                                            </td>
                                        
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $result->annee }}</p>
                                            </td>
                                            <td>
                                            @if(isset($result->nomStyle))
        <p class="text-secondary text-xs font-weight-bold"> {{ str_replace('http://www.semanticweb.org/mega-pc/ontologies/2023/9/untitled-ontology-6#', '', $result->nomStyle ) }}</p>
    @else
