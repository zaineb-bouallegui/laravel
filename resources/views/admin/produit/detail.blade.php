...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
  ...
  <div class="row mt-4">
    <div class="col-lg-6 col-md-6 mt-4 mb-4 mx-auto"> 
      <div class="card z-index-2">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
          <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
            <div class="chart">
              <img src="{{ asset('images/' . $produit->image) }}" alt="{{ $produit->nom }}" class="img-fluid rounded" style="max-width: 100%;">
            </div>
          </div>
        </div>
        ...
        <p class="text-sm mb-0">Nom du produit : {{ $produit->nom }}</p>
        <p class="text-sm mb-0">Catégorie: {{ $produit->categorie->nom }}</p>
        <p class="text-sm mb-0">Description : {{ $produit->description }}</p>
        <p class="text-sm mb-0">Prix : {{ $produit->prix }}</p>

          <!-- Ajoutez d'autres détails du produit ici -->
        </div>
        <!-- Fin de la section de détails du produit -->
      </div>
    </div>
  </div>
</div>
