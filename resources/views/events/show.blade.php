...
<div class="container-fluid py-4">
  ...
  <!-- <div class="card-header">{{ $events->nom }}</div> -->
  <div class="card-body px-4 pt-4 pb-2">
    <div class="card-text">
        <h4 class="card-title mb-4">Nom</h4>
        <p class="card-text">{{ $events->nom }}</p>
    </div>
    <div class="card-text">
    ...
    <div class="card-text">
        <h4 class="card-title mb-4">Lieu</h4>
        <p class="card-text">{{ $events->lieu }}</p>
    </div>
    <div class="card-text">
