...
<div class="container-fluid py-4">
  ...
  <div class="card-header">Modifier évenement</div>
  <div class="card-body">
      ...
      <form action="{{ url('event/' .$events->id) }}" method="post">
        ...
        <label>Nom</label></br>
        <input type="text" name="nom" id="nom" value="{{$events->nom}}" class="form-control"></br>
        <label>Date</label></br>
        <input type="date" name="date" id="date" value="{{$events->date}}" class="form-control"></br>
        <label>Lieu</label></br>
        <input type="text" name="lieu" id="lieu" value="{{$events->lieu}}" class="form-control"></br>
