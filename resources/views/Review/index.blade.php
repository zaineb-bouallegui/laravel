                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach($reviews as $review)
                    <tr>
                      ...
                      <td>
                        <p class="text-xs text-secondary mb-0" style="white-space:normal">{{ $review->message }}</p>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="{{ route('Review.delete', $review) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
